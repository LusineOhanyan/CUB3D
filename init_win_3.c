...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/11 16:16:37 by lohanyan          #+#    #+#             */
/*   Updated: 2023/05/11 16:16:38 by lohanyan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (address->vars.map[i][j] == 'S')
	{
		init_dir(address, 1, 0);
		init_plane(address, 0, -0.66);
	}
	else if (address->vars.map[i][j] == 'N')
	{
		init_dir(address, -1, 0);
		init_plane(address, 0, 0.66);
	}
	else if (address->vars.map[i][j] == 'E')
	{
		init_dir(address, 0, 1);
		init_plane(address, 0.66, 0);
	}
	else if (address->vars.map[i][j] == 'W')
	{
		init_dir(address, 0, -1);
		init_plane(address, -0.66, 0);
	}
